    ...
    return ValueListenableBuilder<WatchMedicine?>(
      ...
      builder: (context, m, _) {
        ...
        return ValueListenableBuilder<int>(
          valueListenable: MedicineScheduleMonitor.instance.medicineQueuedCount,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (queued > 0) ...[
                                ...
                                Text(
                                  queued == 1
                                      ? '1 more medicine after this'
                                      : '$queued more medicines after this',
                                  textAlign: TextAlign.center,
                              ...
                              SizedBox(
                                ...
                                child: OutlinedButton.icon(
                                  ...
                                  onPressed: () =>
                                      MedicineScheduleMonitor.instance.acknowledgeDismiss(),
                                ),
                              ),
                            ],
                          ),
