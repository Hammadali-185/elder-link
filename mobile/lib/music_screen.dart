...
class _MusicScreenState extends State<MusicScreen> {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  '${item.title} � ${_formatCategory(item.category)}',
  ...
  String _formatDateTime(DateTime dt) {
    ...
    return '${w.day}/${w.month}/${w.year} � $hour:$minute $suffix';
  }
  ...
  String _formatTimeRange(DateTime startUtc, DateTime endUtc) {
    ...
    if (sameDay) {
      return '${s.day}/${s.month}/${s.year} � ${fmtTime(s)} - ${fmtTime(e)}';
    }
    return '${s.day}/${s.month}/${s.year} � ${fmtTime(s)} - ${e.day}/${e.month}/${e.year} � ${fmtTime(e)}';
  }
}
